...
4. List tasks: node /Users/kenefe/LOCAL/momo-agent/tools/team/lib/task-manager.js list
...
7. Create tasks targeting specific gaps using:
   node /Users/kenefe/LOCAL/momo-agent/tools/team/lib/task-manager.js create "<title>" "<description>" --milestone <milestoneId>
8. Update tasks using:
   node /Users/kenefe/LOCAL/momo-agent/tools/team/lib/task-manager.js update <taskId> '{"priority":"P0"}'
...
- prd match: 78%
- dbb match: 75%
- architecture match: 88%
- Active group: m88 (M88: Voice Latency Benchmarking + CPU Profiling), tasks: 3
- Total milestones: 15
...
- Reviewed state: m88 has 1 task in testing (waiting for tester), m89/m90 planned with 6 tasks covering all remaining gaps. No new tasks needed.
