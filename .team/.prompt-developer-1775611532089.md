...
Workflow:
1. List tasks: node /Users/kenefe/LOCAL/momo-agent/tools/team/lib/task-manager.js list (shows all tasks with status)
2. Find a task where status is 'todo', hasDesign=true, assignee is null, and all blockedBy tasks are done
3. IMPORTANT: Check if task can be claimed: node /Users/kenefe/LOCAL/momo-agent/tools/team/lib/task-manager.js can-claim <taskId>
4. IMPORTANT: Only pick tasks that have hasDesign=true (a design.md exists)
5. Claim it: node /Users/kenefe/LOCAL/momo-agent/tools/team/lib/task-manager.js update <taskId> '{"assignee":"developer","status":"inProgress"}'
...
8. When done: node /Users/kenefe/LOCAL/momo-agent/tools/team/lib/task-manager.js update <taskId> '{"status":"review"}'
...
- API Error: 429 {"error":{"code":"429","message":"monthly quota exhausted","type":"limitation"}}
